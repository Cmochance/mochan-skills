> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/anti_patterns/deref.md`,许可 **MPL-2.0**。
...
- [Collections are smart pointers idiom](./idiom__deref-for-collections.md).
