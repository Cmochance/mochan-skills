> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/patterns/creational/fold.md`,许可 **MPL-2.0**。
...
The [visitor](./pattern__visitor.md) pattern is closely related to fold.
