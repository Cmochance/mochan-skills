> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/patterns/behavioural/visitor.md`,许可 **MPL-2.0**。
...
The [fold](./pattern__fold.md) pattern is similar to visitor but produces a
