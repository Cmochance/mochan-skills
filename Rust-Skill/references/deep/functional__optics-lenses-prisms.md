> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/functional/optics.md`,许可 **MPL-2.0**。
...
in Rust APIs, such as [visitors](./pattern__visitor.md). They also
