> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/patterns/behavioural/RAII.md`,许可 **MPL-2.0**。
...
[Finalisation in destructors idiom](./idiom__finalisation-in-dtor.md)
