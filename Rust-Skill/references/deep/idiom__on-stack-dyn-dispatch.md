> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/idioms/on-stack-dyn-dispatch.md`,许可 **MPL-2.0**。
...
- [Finalisation in destructors](./idiom__finalisation-in-dtor.md) and
  [RAII guards](./pattern__raii-guards.md) can benefit from tight control
  over lifetimes.
