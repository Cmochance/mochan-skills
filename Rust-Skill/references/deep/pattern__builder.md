> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/patterns/creational/builder.md`,许可 **MPL-2.0**。
...
- [Constructor pattern](./idiom__constructors.md) for when construction is simpler.
