> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/anti_patterns/borrow_clone.md`,许可 **MPL-2.0**。
...
- [`mem::{take(_), replace(_)}` to keep owned values in changed enums](./idiom__mem-replace.md)
