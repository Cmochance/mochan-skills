> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/idioms/mem-replace.md`,许可 **MPL-2.0**。
...
[Clone to satisfy the borrow checker](./antipattern__clone-to-satisfy-borrowck.md)
...
[`Default` trait](./idiom__default-trait.md). However, if the type you're working with
