> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/idioms/deref.md`,许可 **MPL-2.0**。
...
- [Deref polymorphism anti-pattern](./antipattern__deref-polymorphism.md).
