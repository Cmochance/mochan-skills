> **来源**:本文逐字移植自《Rust Design Patterns》(https://github.com/rust-unofficial/patterns) 的 `src/patterns/ffi/wrappers.md`,许可 **MPL-2.0**。
...
[Object-Based APIs](./ffi__exporting-rust-to-c.md) for more on the advantages and pitfalls this
avoids.
